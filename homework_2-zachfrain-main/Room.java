...
/**
 * Returns a non-formatted string that contains the attributes of the room
 * @return The string containing the attributes of the room
 */
	public String simpleString() {
		return number + " " + capacity + " " + area + " ";
	}
}
